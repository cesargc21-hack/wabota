...
───────────── ✨●•٠·`
				...
				num = anu.participants[0]
				teks = `*Adiós* @${num.split('@')[0]}👋no te extrañaremos`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
*〘 ANIME 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Kusonime (Consulta)*
┃ _Buscar información de anime en kusonime_
┠⊷️ *${prefix}Neonime (Consulta)*
┃ _Busca información de anime en neonime_
┠⊷️ *${prefix}Charnime (Consulta)*
┃ _Busca información de personajes de anime_
┠⊷️ *${prefix}Wait*
┃ _Detectar informacion de anime de la imagen_
┠⊷️ *${prefix}Anime*
┃ _Buscando imagenes de anime_
┠⊷️ *${prefix}Loli*
┃ _Buscando imágenes de anime loli_
┠⊷️ *${prefix}Neko*
...
┠⊷️ *${prefix}Wasted*
┃ _Hacer pegatinas desperdiciadas_
┠⊷️ *${prefix}Ttp (Texto)*
